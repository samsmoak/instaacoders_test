...
function HomeProSlider() {
	...
	const navigationPrevRef7 = React.useRef(null);
	const navigationNextRef7 = React.useRef(null);
	...
	return (
		...
		>
			...
			<Swiper
				...
				navigation={{
					prevEl: navigationNextRef7.current,
					nextEl: navigationPrevRef7.current,
				}}
